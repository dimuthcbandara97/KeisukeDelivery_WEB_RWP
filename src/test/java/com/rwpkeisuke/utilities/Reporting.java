package com.rwpkeisuke.utilities;
...
public class Reporting extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		String repName="KEIUKE_AUTOMATION_"+timeStamp+".html";
		...
		extent.setSystemInfo("Environemnt","KEISUKE_WEB_AUTOMATION");
		extent.setSystemInfo("user","I_D_C_Bandara");
		
		htmlReporter.config().setDocumentTitle("KEISUKE_WEB_AUTOMATION"); // Tile of report
